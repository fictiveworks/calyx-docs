...
class Logo < Calyx::Grammar
  ...
  document '
    <svg width="400px"
      ...
      <use xlink:href="#ordinal" fill="{$swatch_fill}" stroke="{swatch_fill}" stroke-width="{stroke_width}" transform="scale(0.80 0.80) translate(50 50) rotate(45 200 200)" />
      <use xlink:href="#ordinal" fill="{$swatch_fill}" stroke="{swatch_fill}" stroke-width="{stroke_width}" transform="scale(0.80 0.80) translate(50 50) rotate(45 200 200)" />
      <use xlink:href="#cardinal" fill="{$swatch_fill}" stroke="{swatch_fill}" stroke-width="{stroke_width}" transform="scale(0.40 0.40) translate(300 300) rotate(45 200 200)" />
    </svg>
  '
  vertices '{vertex_north}{vertex_nw}{vertex_west}{vertex_sw}{vertex_south}{vertex_se}{vertex_east}{vertex_ne}'
  ...
  vertex_north '<circle cx="200" cy="120" r="{@rx}" />'
  vertex_south '<circle cx="200" cy="280" r="{@rx}" />'
  vertex_east '<circle cx="280" cy="200" r="{@rx}" />'
  vertex_west '<circle cx="120" cy="200" r="{@rx}" />'
